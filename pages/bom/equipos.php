...
if (isset($_POST['post'])) {
	...
	//Mysql
	$result     = 	mysqli_query($link,"SELECT * FROM equipos WHERE proyecto='$proyecto' ORDER BY id DESC");
    $row        = 	mysqli_fetch_array($result);            
    $id         =	($row["id"]+1);
	mysqli_query($link,"INSERT INTO equipos(id,ref,des,marca,prov,fecha_c,precio,unid,nota,proyecto) VALUES('$id','$ref','$des','$marca','$prov','$fecha_c','$valor','$unid','$nota','$proyecto')");
