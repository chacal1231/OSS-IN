...
if (isset($_POST['post'])) {
    ...
    $id         =	($row["id"]+1);
	mysqli_query($link,"INSERT INTO herra(id,ref,des,marca,prov,fecha_c,precio,unid,nota,proyecto) VALUES('$id','$ref','$des','$marca','$prov','$fecha_c','$valor','$unid','$nota','$proyecto')");
