...
if (isset($_POST['post'])) {
	...
	//Mysql
	$result     = 	mysqli_query($link,"SELECT * FROM repuestos WHERE proyecto='$proyecto' ORDER BY id DESC");
    $row        = 	mysqli_fetch_array($result);            
    $id         =	($row["id"]+1);
	mysqli_query($link,"INSERT INTO repuestos(id,ref,des,marca,prov,fecha_c,precio,unid,nota,proyecto) VALUES('$id','$ref','$des','$marca','$prov','$fecha_c','$valor','$unid','$nota','$proyecto')");
...
//Query tabla
$QueryTabla =	mysqli_query($link,"SELECT * FROM repuestos WHERE proyecto='$proyecto' ORDER BY id DESC");
        ...
        <section class="panel">
            ...
            <section class="panel">
                        <div class="panel-body"> 
                        	<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Agregar repuestos</button>
                            <hr/>
