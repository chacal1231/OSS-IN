...
if (isset($_POST['post'])) {
	...
	//Mysql
	$result     = 	mysqli_query($link,"SELECT * FROM equipos WHERE proyecto='Gen' ORDER BY id DESC");
...
//Query tabla
$QueryTabla =	mysqli_query($link,"SELECT * FROM equipos WHERE proyecto='Gen' ORDER BY id DESC");
