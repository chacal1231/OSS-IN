...
if (isset($_POST['post'])) {
	...
	//Mysql
	$result     = 	mysqli_query($link,"SELECT * FROM alquiler ORDER BY id DESC");
    $row        = 	mysqli_fetch_array($result);            
    $id         =	($row["id"]+1);
	mysqli_query($link,"INSERT INTO alquiler(id,ref,des,marca,prov,fecha_c,precio,unid,nota,proyecto) VALUES('$id','$ref','$des','$marca','$prov','$fecha_c','$valor','$unid','$nota','$proyecto')");
        ...
        <section class="panel">
            ...
            <section class="panel">
                        <div class="panel-body"> 
                        	<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Agregar alquiler</button>
                            <hr/>
